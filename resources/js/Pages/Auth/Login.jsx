						...
						<div className="container">
							<div className="row">
										...
										<div className="card-body">
											...
											<form onSubmit={storeLogin}>
												...
												<div className="text-center">
													<button type="submit" className="btn btn-lg bg-gradient-success btn-lg w-100 mb-0">Log in</button>
												</div>
											</form>
										</div>
								...
								<div className="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column">
									<div className="position-relative bg-gradient-success h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden">
